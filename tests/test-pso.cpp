...
TEST_CASE("PSO: single-thread") {
    ...
    auto states = interpreter.run<PSOStorageSubsystem>();
...
TEST_CASE("PSO: store-buffering-strong") {
    std::string path = test_data_path + "/store-buffering-strong.txt";
    std::string code = fs::FileReader::read_file(path);
...
TEST_CASE("PSO: message-passing-strong-seq-cst") {
    std::string path = test_data_path + "/message-passing-strong-seq-cst.txt";
    std::string code = fs::FileReader::read_file(path);
