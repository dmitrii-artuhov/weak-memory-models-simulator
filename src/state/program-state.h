...
struct ProgramState {    
    ...
    ProgramState get_interleaving_state(int new_active_thread_id) const;
    ProgramState get_transition_state() const;
    std::vector <ProgramState> get_eps_transition_states() const;
